...
import 'package:healthandwellness/features/partGuide/exercise/ex_components/cameraa.dart';
import 'package:healthandwellness/main.dart';

import '../ex_components/key_points.dart';

class SumoPulsesExercise extends StatefulWidget {
  ...
  @override
  State<SumoPulsesExercise> createState() => _SumoPulsesExerciseState();
}

class _SumoPulsesExerciseState extends State<SumoPulsesExercise> {
    ...
    List<Widget> _renderKeypoints() {
      ...
      widget.data.forEach((re) {
        var list = re["keypoints"].values.map<Widget>((k) {
          ...
          return Positioned(
            left: (cameraNumber == 1) ? x - 230 : x,
            top: (cameraNumber == 1) ? y - 50 : y - 100,
            width: 100,
            height: 15,
            child: Container(
              color: Colors.black,
