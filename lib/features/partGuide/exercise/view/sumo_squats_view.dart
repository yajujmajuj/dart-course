...
class SumoSquatsView extends StatefulWidget {
  const SumoSquatsView({super.key});

  @override
  SumoSquatsViewState createState() => SumoSquatsViewState();
}

class SumoSquatsViewState extends State<SumoSquatsView> {
