...
import '../repository/side_plank_exercise.dart';

class SidePlankExerciseView extends StatefulWidget {
  const SidePlankExerciseView({super.key});

  @override
  SidePlankExerciseViewState createState() => SidePlankExerciseViewState();
}

class SidePlankExerciseViewState extends State<SidePlankExerciseView> {
