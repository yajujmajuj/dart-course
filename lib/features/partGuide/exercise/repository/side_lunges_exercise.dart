...
class SideLungesExercise extends StatefulWidget {
  ...
  @override
  _SideLungesExerciseState createState() => _SideLungesExerciseState();
}

class _SideLungesExerciseState extends State<SideLungesExercise> {
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (exercise == 'squat') {
      if (squatUp) {
        return shoulderLY < 320 &&
            shoulderLY > 280 &&
            shoulderRY < 320 &&
            shoulderRY > 280;
      } else {
        return shoulderLY > 475 && shoulderRY > 475;
      }
    }
    return false;
  }
